...
namespace Chess
{
    class Moves
    {
        ...
        private bool CanRookMove()
        {
            ...
            return ((fm.SignX == 0 && fm.SignY != 0) || (fm.SignX != 0 && fm.SignY == 0)) && CanQueenMove();
        }

        private bool CanBishopMove()
        {
            
            return (fm.SignX != 0 && fm.SignY != 0) && CanQueenMove();
        }
        private bool CanKnightMove()
        {
            if ((fm.AbsDeltaX == 1 && fm.AbsDeltaY == 2) || (fm.AbsDeltaX == 2 && fm.AbsDeltaY == 1)) return true;
            return false;
        }
