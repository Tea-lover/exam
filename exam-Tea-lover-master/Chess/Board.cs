...
namespace Chess
{
    class Board
    {
        ...
        void Init()
        {
            ...
            //0                                                         1 2    3 4 5
            string[] parts = fen.Split();//делим fen на кусочки 
            if (parts.Length != 6) return;
            InitFigures(parts[0]);//инициализация фигур
            moveColor = (parts[1] == "b") ? Color.black : Color.white;//цвет
            moveNumber = int.Parse(parts[5]);
           //ничью, взятие на проходе и рокировку не контролируем.
        }
        ...
        public bool IsCheck()
        {
            ...
            return after.CanBeatKing();//есть ли шах после хода?
        }
